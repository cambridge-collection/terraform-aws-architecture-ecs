...
| <a name="input_waf_bot_control_exclusion_header"></a> [waf\_bot\_control\_exclusion\_header](#input\_waf\_bot\_control\_exclusion\_header) | Name of header to exclude from WAF bot control | `string` | `null` | no |
| <a name="input_waf_bot_control_exclusion_header_match_type"></a> [waf\_bot\_control\_exclusion\_header\_match\_type](#input\_waf\_bot\_control\_exclusion\_header\_match\_type) | Match type for the bot control exclusion header | `string` | `"CONTAINS"` | no |
| <a name="input_waf_bot_control_exclusion_header_text_transform"></a> [waf\_bot\_control\_exclusion\_header\_text\_transform](#input\_waf\_bot\_control\_exclusion\_header\_text\_transform) | Text transformation to apply before matching the exclusion header for WAF bot control | `string` | `"NONE"` | no |
| <a name="input_waf_bot_control_exclusion_header_value"></a> [waf\_bot\_control\_exclusion\_header\_value](#input\_waf\_bot\_control\_exclusion\_header\_value) | Value of header to exclude from WAF bot control | `string` | `null` | no |
