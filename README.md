...
| <a name="input_vpc_nat_gateway_create"></a> [vpc\_nat\_gateway\_create](#input\_vpc\_nat\_gateway\_create) | Whether to create a NAT Gateway. Note this can have a cost impact | `bool` | `false` | no |
