...
| [aws_iam_role_policy_attachment.ec2_additional](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy_attachment) | resource |
...
| <a name="input_iam_instance_additional_policies"></a> [iam\_instance\_additional\_policies](#input\_iam\_instance\_additional\_policies) | Map of additional IAM Policy ARNs to apply to the EC2 instance profile. Values should be Policy ARNs; Keys are descriptive strings | `map(string)` | `{}` | no |
